...
combophil_alg_log(_N1,G1,G2) :-
	...
	foldr(string_concat,["What is ",Phil412," because ",Phil410012," because ",Phil410013," in one sentence?"],Q1),
	writeln(Q1),
	q(Q1,A1),
	writeln(A1),

	foldr(string_concat,["What is a useful Prolog algorithm for ",Phil412," because ",Phil410012," because ",Phil410013,"?"],Q2),
	writeln(Q2),
	q(Q2,A2),
	writeln(A2))),
G2=[A1,A2].
