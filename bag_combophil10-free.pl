...
:- include('../Text-to-Breasonings/big_connections_with_bag3_and_mr_short_books_aa540_args_init2.pl').
:- include('../private/chatgpt_qa.pl').
:- include('../../GitHub-private2/Text-to-Breasonings/text_to_breasonings.pl').
...
bag_combophil(Books,Num%,In_String%,Out_List
):-
...
findall(G4,(member(_,Nums),
	combophil_alg_log(N1,G3,G4)),G41),
...
working_directory1(_,"../../GitHub-private2/Text-to-Breasonings"),
...
*/
	...
	%abort,
 	...
 	working_directory(A000,A000),
 	working_directory(_,'../../Text-to-Breasonings/'),
	
	big_connections_with_bag3_and_mr(Q1,A1),
...
get_text10(R,Text%Phil412
) :-
	random_member([Dept,Folder,_N2],R),
	%N2=<N1,
	get_texts1(Dept,Folder,Text2),
	split_string_on_non_alpha(Text2,Text1),
	truncate(Text1,50,Text3),
	findall([A," "],member(A,Text3),B),
	foldr(append,B,C),
	foldr(string_concat,C,Text).
a:-
	SepandPad="\n\r",
